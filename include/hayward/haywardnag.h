...
// Spawn haywardnag. If haywardnag->detailed, then haywardnag->fd[1] will left open
// so it can be written to. Call haywardnag_show when done writing. This will
// be automatically called by haywardnag_log if the instance is not spawned and
// haywardnag->detailed is true.
bool haywardnag_spawn(const char *haywardnag_command,
		struct haywardnag_instance *haywardnag);

// Write a log message to haywardnag->fd[1]. This will fail when haywardnag->detailed
// is false.
